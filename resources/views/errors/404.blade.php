                ...
                <div class="col-xxl-6 col-xl-7 col-md-6">
                    <div class="d-flex flex-column justify-content-between vh-100">
                        ...
                        <div class="d-flex flex-column justify-content-center align-items-center mb-4">
                            <div class="mb-4">
                                <img src="{{ asset('asset/img/error/error-404.svg') }}" class="error-img img-fluid"
                                    alt="Img">
                            </div>
                            <h3 class="h2 mb-3">Oops, ada yang tidak beres.</h3>
                            <p class="text-center"><u>Error 404 Page not found</u>. Halaman tidak ditemukan. Maaf, halaman yang Anda cari tidak ada atau telah dipindahkan.</p>

            ...
            <div class="d-flex align-items-center flex-wrap">
                <div class="dropdown mb-3">
                    <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="ti ti-circle-plus"></span> Buat Kelas
                    </button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li><a href="{{ route('classroom.tugas',$id) }}" class="dropdown-item" href="#"><span class="ti ti-clipboard-list"></span> Tugas</a></li>
                        <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#addMateri"><span class="ti ti-clipboard-text"></span> Tugas Kuis</a></li>
                        <li><a class="dropdown-item" href="#"><span class="ti ti-clipboard-check"></span> Pertanyaan</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="card board-hover mb-3">
                    <div class="card-body d-md-flex align-items-center justify-content-between pb-1">
                        ...
                        <div class="d-flex align-items-center board-action mb-3">
                            ...
                            <a href="javascript:void(0);"  class="text-danger border rounded p-1  me-1 badge danger-btn-hover">
                    ...
                    <div class="card-body pb-1">
                        <div class="d-md-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center board-action mb-3">
                                ...
                                <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete-modal-{{ $item->id }}" class="text-danger border rounded p-1 badge danger-btn-hover">
                                    <i class="ti ti-trash-x fs-16"></i>
                                </a>
                            </div>
                        </div>

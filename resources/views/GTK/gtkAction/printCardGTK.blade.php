        ...
        <div class="row g-2 d-flex justify-content-center">
            ...
            <div class="card-container-back border shadow p-2 me-2">
                <div class="d-flex justify-content-between">
                    <div class="me-2">
                        <img src="{{ app('settings')['site_logo'] == '' ? asset('asset/img/default-logo.png') : asset('storage/' . app('settings')['site_logo']) }}"
                            alt="logo" width="44px" style="margin-top: -3px;">
                    </div>
                    <div class="header">
                        ...
                        <div class="alamat">
                            ...
                            <p style="font-size: 5px;">Email : <span class="text-primary">{{ app('settings')['email']
                                    }}</span> Telp : {{ app('settings')['phone'] }}</p>
                        </div>
                ...
                <div class="photo me-2"
                    style="background: url('{{ $item->gambar ? asset('storage/'.$item->gambar) : asset('asset/img/user-default.jpg') }}') no-repeat center center; background-size: cover;">
                </div>
            ...
            <div class="card-container border shadow p-2 me-2">
                ...
                <p
                    style="font-size:7px;color:white;margin-top:60px !important;margin-right:-10px;float:right;transform: rotate(90deg);">
                    {{ (isset($_SERVER['HTTPS']) ? "" : ""). $_SERVER['HTTP_HOST'] }}</p>
            </div>
            @endforeach
        </div>
    </div>

$(document).ready(function () {
    ...
    $("#imgInp").change(function () { readURL(this); }); if ($('.datetimepickerCustom').length > 0) { $('.datetimepickerCustom').datetimepicker({ format: 'DD/MM/YYYY', icons: { up: "fas fa-angle-up", down: "fas fa-angle-down", next: 'fas fa-angle-right', previous: 'fas fa-angle-left' } }); }

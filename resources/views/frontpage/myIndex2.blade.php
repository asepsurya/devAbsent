...
<body>
    ...
    <main class="main" id="top">
        <div id="topbar" class="topbar py-1 text-center text-white bg-primary">
            ...
            <button hidden class="btn-close btn-close-white" id="closeTopbar" aria-label="Close"></button>
        </div>
        ...
        <section class="py-0 bg-light-gradient" id="section1">
            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-5 order-md-1 " style="padding-top:70px;">
                        ...
                        <div class=" mb-2 mt-2">
                            ...
                            <form action="/api/absent/entry" method="GET" id="absentForm">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="rfid" class="form-control" id="rfidInput2" maxlength="10" placeholder="Masukan ID Kartu anda">
                                    <input type="text" name="rfid" class="form-control" id="id_rfid" maxlength="10" placeholder="Masukan ID Kartu anda">
                            ...
                            <div class="mb-3" hidden >
                                ...
                                <select id="id_rfid2sss" class="form-select">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content shadow-lg border-0 rounded-4">
            <div class="modal-header border-0">
              <h5 class="modal-title fw-bold" id="successModalLabel">Absensi Berhasil</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
            </div>
            <div class="modal-body" id="modalBody">
              <!-- Dynamic content di-inject lewat JS -->
            </div>
          </div>
        </div>
      </div>
...
function getDataDetail(id_rfid) {
    if (!id_rfid) return;
                ...
                if (!modalOpen) {
                    ...
                    $('#modalBody').html(
                        `<div class="text-center mb-3">
                            <img src="${data.foto ? `{{ asset('storage') }}/${data.foto}` : `{{ asset('asset/img/user-default.jpg') }}`}"
                                class="rounded-circle"
                                style="width: 120px; height: 120px; object-fit: cover;"
                                alt="foto">
                        </div>
                        <div class="mb-3 text-center">
                            <h5 class="mb-1 fw-bold">${data.nama}</h5>
                            <small class="text-muted">NIS: ${data.id}</small>
                        </div>
                        <div class="alert alert-success text-center">
                            Sudah absen pada pukul <strong>${data.jam}</strong>
                        </div>
                        <div class="text-center mb-3">
                            <small class="text-muted">
                                Halaman ini akan ditutup otomatis dalam
                                <span id="countdownNumber">3</span> detik.
                            </small>
                        </div>`
                    );

...
<div class="card">
    <div class="card-header">
        ...
        <select name="" id="" class="form-control select2">
            ...
            <option value="{{ $item->id }}">Tahun Pelajaran : {{ $item->tahun_pelajaran }} - {{ $item->semester }}
            </option>
            @endforeach
        </select>
    </div>
            ...
            <table class="table table-nowrap mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="hstack gap-2 fs-15"><a data-bs-toggle="tooltip" data-bs-placement="bottom"
                                    href="" class="btn btn-icon btn-sm btn-soft-info rounded-pill" aria-label="Edit"
                                    data-bs-original-title="Edit"><span class="ti ti-pencil"></span></a>
                        </td>
                        <td class="border">
                            @if($item->day == 1)
                            Senin
                    ...
                    <div class="p-3 mt-0">
                        ...
                        <ul class="nav nav-tabs nav-tabs-top mb-3" role="tablist">
                            <li class="nav-item" role="presentation"><a class="nav-link active" href="#top-tab1"
                                    data-bs-toggle="tab" aria-selected="true" role="tab">Referensi</a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link" href="#top-tab2"
                                    data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab">Mata
                                    Pelajaran</a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane show active mb-2" id="top-tab1" role="tabpanel">
                                ...
                                <small>Tambah Referensi <a data-bs-toggle="modal" href="#ref" class="link-primary">tambah
                                    referensi</a></small>
                            </div>
                            <div class="tab-pane" id="top-tab2" role="tabpanel">
                                <div class="mb-2">
                                    <label class="form-label">Mata Pelajaran / <i>Ref </i><span class="text-danger">*</span>
                                    </label>
                                    <select name="id_mapel" id="mapel" class="form-control select2" required>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="id_kelas" id="id_kelas" class="form-control" value="{{ $id }}"
                                        hidden>
                ...
                <form action="{{ route('reference') }}" method="post">
                    ...
                    <div class="bg-light">
                        <div class="m-3">
                            ...
                            <input type="text" class="form-control" name="ref" required placeholder="Ex:Ishoma,Upacara">
                            <button class="btn btn-primary mt-2 w-100">Tambah</button>
                        </div>
                    </div>

                    <div class="accordion accordions-items-seperate" id="accordionSpacingExample">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><span class="ti ti-pencil" id="edit"></span></td>
                                                    <td><a href="#" class="link-primary">{{ $item->ref_ID }}</a></td>
                                                    <td>
                                                        <div id="ref_item">{{$item->ref}}</div>
                                                    </td>
                                                    <td><button class="activate btn btn-outline-light bg-white"><span class="ti ti-device-floppy"></span></button></td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>

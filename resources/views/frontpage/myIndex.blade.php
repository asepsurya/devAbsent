...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <style>
        .form-control:focus {
            ...
            background-color: initial; /* Mengembalikan latar belakang ke default */
        }
      /* Gallery style */
      .instagram-feed {
          display: grid;
  ...
  <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
    ...
    // Mencegah input kehilangan fokus saat pengguna mengklik elemen lain
    inputElement.addEventListener('blur', function(event) {
      // Mencegah kehilangan fokus
      inputElement.focus();
    });

    // Ini hanya untuk mendemonstrasikan klik di elemen lain
    document.getElementById("otherElement").addEventListener('click', function() {
      alert("Button clicked! But the input will remain focused.");
    });
  });
</script>
      </script>

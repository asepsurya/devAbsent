                        ...
                        <div class="d-flex flex-column justify-content-between vh-100">
                            ...
                            <div class="card">
                                <div class="card-body p-4">
                                    <div class=" mb-3">
                                        <center class="mb-3"><img src="{{ app('settings')['site_logo'] == '' ? asset('asset/img/default-logo.png') : asset('storage/' . app('settings')['site_logo'] ) }}" class="img-fluid" alt="Logo" width="50px"></center>
                                        ...
                                        <p class="mb-0 text-center">
                                            ...
                                            <p>Kami akan memberi tahu Anda segera setelah akun Anda siap digunakan. Jika Anda memiliki pertanyaan atau membutuhkan bantuan lebih lanjut, jangan ragu untuk menghubungi kami <b>(Administrator)</b>.</p>

                                        </p>
                                    </div>

                                    <a  href="/" class="btn btn-primary w-100">Oke</a>
                                </div>
                            </div>
